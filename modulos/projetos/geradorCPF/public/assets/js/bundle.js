...
var GeraCPF = /*#__PURE__*/function () {
  ...
  _createClass(GeraCPF, [{
    ...
    value: function rand() {
      ...
      var num = String(Math.floor(Math.random() * (max - min) + min));
      return num;
    }
  }, {
    key: "formatado",
...
var ValidaCPF = /*#__PURE__*/function () {
  ...
  _createClass(ValidaCPF, [{
    ...
    value: function valida() {
      ...
      var d1 = this.criaDigito(cpfParcial);
      var d2 = this.criaDigito(cpfParcial + d1);
      var novoCPF = cpfParcial + d1 + d2;
    ...
    value: function criaDigito(cpfParcial) {
      var cpfArr = Array.from(cpfParcial);
      var reg = cpfArr.length + 1;
      var total = cpfArr.reduce(function (ac, val) {
        ac += reg * Number(val);
        reg--;
        return ac;
      }, 0);
